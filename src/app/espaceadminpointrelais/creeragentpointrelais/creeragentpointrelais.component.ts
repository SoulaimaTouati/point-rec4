...
@Component({
  selector: 'app-creeragentpointrelais',
  templateUrl: './creeragentpointrelais.component.html',
  styleUrl: './creeragentpointrelais.component.css'
})
export class CreeragentpointrelaisComponent {
  isOpen: boolean = true;
